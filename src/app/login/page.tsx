...
import { Zap, Mail, Lock, Bot } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center gradient-bg p-4">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">AI Agent Automation Platform</p>
        </div>

        <Card className="border-zinc-800/50 bg-zinc-900/80 backdrop-blur-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-xl">{isSignUp ? "Create Account" : "Welcome Back"}</CardTitle>
            <CardDescription>
              {isSignUp ? "Start building AI automations" : "Sign in to your account"}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              variant="outline"
              className="w-full h-11 border-zinc-700 hover:bg-zinc-800"
